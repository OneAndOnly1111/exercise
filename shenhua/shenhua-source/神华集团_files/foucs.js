...
var foucsbox2 = function (time) {
    var time = time || 3500
    , $ = function (id) { return document.getElementById(id); }
    , topCon = $('divimgplay2')
    , big = $('divimginfog_imgPlayer2')
    , samll = $('divpageinfog_imgPlayer2')
    , tip = $('ptitleg_imgPlayer2')
    , bigimgs = big.getElementsByTagName('li')
    , samllimgs = samll.getElementsByTagName('li')
    , imglink = tip.getElementsByTagName('a')[0]
    , slide = function (z) {
...
var foucsbox3 = function (time) {
    var time = time || 3500
    , $ = function (id) { return document.getElementById(id); }
    , topCon = $('divimgplay3')
    , big = $('divimginfog_imgPlayer3')
    , samll = $('divpageinfog_imgPlayer3')
    , tip = $('ptitleg_imgPlayer3')
    , bigimgs = big.getElementsByTagName('li')
    , samllimgs = samll.getElementsByTagName('li')
    , imglink = tip.getElementsByTagName('a')[0]
    , slide = function (z) {
